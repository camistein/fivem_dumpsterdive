...
export const displayText = (
	...
	if (!!settings.textStyle) {
		...
		SetTextColour(
			settings.textStyle.color.red,
			settings.textStyle.color.green,
			settings.textStyle.color.blue,
			settings.textStyle.color.alpha,
		);
		SetTextDropshadow(
			settings.textStyle.textDropShadow.distance,
			settings.textStyle.textDropShadow.red,
			settings.textStyle.textDropShadow.green,
			settings.textStyle.textDropShadow.blue,
			settings.textStyle.textDropShadow.alpha,
		);
	} else {
